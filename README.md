...
**`Junior Software Engineer`** **`Developer`** **`Video Editor`** **`Roblox Developer`** **`Hobbyist Minecraft Developer`** **`Hobbyist Music Composer`**
   ...
   <p align="left">
      <a href="https://discord.nt-neptune.de">
      ...
      <a href="https://portfolio.eu-neptune.de">
...
1. 🗣 Commented on [#35](https://github.com/AkselGlyholt/velocity-limbo-handler/issues/35#issuecomment-3362274663) in [AkselGlyholt/velocity-limbo-handler](https://github.com/AkselGlyholt/velocity-limbo-handler)
